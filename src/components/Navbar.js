...
const Navbar = ({ cart = [], user = null, logout = () => {}, searchTerm = '', onSearchChange = () => {} }) => {
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    {user ? (
                        <>
                            ...
                            {user.isAdmin && <Link to="/admin" style={{ marginLeft: 10, color: '#fff' }}>Admin</Link>}
